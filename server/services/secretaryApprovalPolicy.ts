...
const actionPolicyMatrix: Record<SecretaryActionName, Omit<SecretaryPolicyDecision, "capability">> = {
  ...
  criar_contrato: { sensitivity: "high", requiresHumanApproval: true, auditLevel: "elevated", reason: "cria registro contratual" },
  cadastrar_contrato: { sensitivity: "high", requiresHumanApproval: true, auditLevel: "elevated", reason: "cria registro contratual" },
  criar_prazo: { sensitivity: "medium", requiresHumanApproval: false, auditLevel: "standard", reason: "registra prazo operacional" },
  cadastrar_prazo: { sensitivity: "medium", requiresHumanApproval: false, auditLevel: "standard", reason: "registra prazo operacional" },
  agendar_evento: { sensitivity: "medium", requiresHumanApproval: false, auditLevel: "standard", reason: "agenda compromisso" },
  atualizar_evento: { sensitivity: "medium", requiresHumanApproval: false, auditLevel: "standard", reason: "atualiza compromisso" },
  agendar_compromisso: { sensitivity: "medium", requiresHumanApproval: false, auditLevel: "standard", reason: "agenda compromisso" },
  criar_fatura: { sensitivity: "high", requiresHumanApproval: true, auditLevel: "elevated", reason: "cria cobranca financeira" },
  atualizar_fatura: { sensitivity: "high", requiresHumanApproval: true, auditLevel: "elevated", reason: "atualiza cobranca financeira" },
  contatar_terceiro: { sensitivity: "high", requiresHumanApproval: false, auditLevel: "elevated", reason: "envia mensagem externa e acompanha resposta" },
